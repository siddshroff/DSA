...
public class LeetCode1920 {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(zeroPermutation(nums)));
        System.out.println(Arrays.toString(zeroPermutationOptimized(nums)));
    }

    private static int[] zeroPermutation(int[] nums) {
    ...
    private static int[] zeroPermutationOptimized(int[] nums) {
        int n = nums.length;
