...
public class LeetCode1773 {
    public static void main(String[] args) {
        ...
        LeetCode1773 obj1773 = new LeetCode1773();
        System.out.println(obj1773.countMatches(items, ruleKey, ruleValue));
        System.out.println(obj1773.countMatchesOther(items, ruleKey, ruleValue));
    }

    //Solution1: Runtime: 12ms(32.8%), Memory: 57.3MB(7.3%)
    private int countMatchesOther(List<List<String>> items, String ruleKey, String ruleValue) {
        int a, b, c, i = 0;
        String s;
