...
public class LeetCode1512 {
    public static void main(String[] args) {
        ...
        LeetCode1512 obj1512 = new LeetCode1512();
        System.out.println(obj1512.findGoodPair(nums));
        System.out.println(obj1512.findGoodPairOptimised(nums));
    }

    //Solution1: Runtime: 1ms(89.70%), Memory: 41.3MB(61.79%)
//Usage of data structure solves half problem- hash getOrDefault
    private int findGoodPairOptimised(int[] nums) {
    ...
    private int findGoodPair(int[] nums) {
        int pairCounter = 0;
